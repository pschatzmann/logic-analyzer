...
/**
 * Simple class to manage User callbacks. An optinal parameter can be passed to the callback method
 */
class UserCallback {
  public:
...
/**
 * Simple class to manage the different timer callbacks for the 4 hardware timers
 */
class TimerCallback {
  public:
      TimerCallback() {
...
class TimerAlarmRepeating {
    public:
        ...
        /**
         * We can not do any expensive calls (e.g. I2C) in the interrupt handler so we need to do this in a separate task
         */
